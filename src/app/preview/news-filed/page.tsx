...
import { NewsCards } from "@/components/news/options/NewsCards";
import { NewsSwitch } from "@/components/news/options/NewsSwitch";
import { newsArticles, newsCopy } from "@/data/news";

export const metadata: Metadata = {
  title: "News option E — Filed — SEVENPM",
  robots: { index: false },
};

/** News option E: the archive as a drawer of index cards, tabbed by category and stamped with the date. */
export default function NewsFiledPreview() {
  return (
    <>
      <MotionProvider />
      <SiteHeader />
